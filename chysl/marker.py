        ...
        match self.marker:
            ...
            case constants.HEXAGON:
                ...
                elem = Element(
                    ...
                    transform=f"translate({utils.N(x)}, {utils.N(y)}) scale({utils.N(scale)}) translate(-255.7, -221.5)",
                    fill="none",
                    stroke=self.color,
                )
            ...
            case constants.STAR:
                ...
                elem = Element(
                    ...
                    transform=f"translate({utils.N(x)}, {utils.N(y)}) scale({utils.N(scale)}) translate(-25, -24)",
                    fill="none",
                    stroke=self.color,
                )
                elem["stroke-width"] = 5
