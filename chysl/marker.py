...
class Marker:
    ...
    def get_graphic(self, x, y):
        ...
        stroke_width = utils.N(2 * self.size / constants.DEFAULT_SIZE)
        ...
        match self.marker:
            ...
            case constants.PENTAGON:
                ...
                elem = Element("path",
                               ...
                               transform=f"translate({utils.N(x)}, {utils.N(y)}) scale({utils.N(scale)}) translate(-20, -20)",
                               stroke=self.color,
                               fill="none")
            ...
            case constants.STAR:
                ...
                elem = Element("path",
                               ...
                               transform=f"translate({utils.N(x)}, {utils.N(y)}) scale({utils.N(scale)}) translate(-130, -150)",
                               stroke="none",
                               fill=self.color)
                self.label_x_offset = self.size / 2.5
            ...
            case constants.SUN:
                ...
                circle = Element("path",
                                 ...
                                 stroke=self.color,
                                 fill="none")
                circle["stroke-width"] = utils.N(scale * 6)
                ...
                elem = Element("g",
                               Element("path",
                                       ...
                                       fill=self.color),
                               circle,
                               transform=f"translate({utils.N(x)}, {utils.N(y)}) scale({utils.N(scale)}) translate(-6,-6)",
                               )
                self.label_x_offset = self.size / 2.5
            ...
            case constants.MERCURY:
                ...
                elem = Element("path",
                            ...
                            d="M8 5a1.999 1.999 0 1 0-4 0 1.999 1.999 0 1 0 4 0ZM4 1a1.999 1.999 0 1 0 4 0M6 11V7M4 9h4",
                               stroke=self.color,
                               fill="none")
                elem["stroke-width"] = utils.N(scale * 0.6)
                elem["stroke-linecap"] = "round"
                self.label_x_offset = self.size / 5
            ...
            case constants.ALPHA:
                ...
                elem = Element("path",
                               transform=f"translate({utils.N(x)}, {utils.N(y)}) scale({utils.N(1.3*self.size/400)}) translate(-200,-200)",
